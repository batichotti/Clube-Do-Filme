    ...
    <main class="mainAdm pt-5 pb-5">
      <form id="palavrasChave" class="telaCadastro p-5">
        ...
        <div class="botoesCRUD d-flex flex-column row-gap-2">
          <button action="" name="botaoBuscarK" class="botaoAdm buscar">
            Buscar
          </button>
          <button
            action=""
          ...
          <button action="" name="botaoExluirk" class="botaoAdm excluir" hidden>
            Excluir
          </button>
          <button
            action=""
          ...
          <button action="" name="botaoSalvarK" class="botaoAdm excluir" hidden>
            Salvar
          </button>
        </div>
